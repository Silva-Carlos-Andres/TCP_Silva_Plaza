<%@ Page Title="Marcas" ValidateRequest="false" EnableEventValidation="false"  Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="Marcas.aspx.cs" Inherits="TPC___Silva___Plaza.Marcas" %>
            ...
            <ItemTemplate> 
                    <tbody>
                        <tr>
                            ...
                            <td><asp:Button Text="Editar" CommandArgument='<%#Eval("id") %>' ID="btneditar" CommandName="IDMarca" OnClick="btneditar_Click" AutoPostBack="true" runat="server" /> </td>
                            ...
                            <td><asp:Button Text="Borrar" CommandArgument='<%#Eval("id") %>' ID="btnBorrar" OnClientClick="return clearOnConfirm();" CommandName="IDMarca" OnClick="btnBorrar_Click" runat="server" /> </td>
