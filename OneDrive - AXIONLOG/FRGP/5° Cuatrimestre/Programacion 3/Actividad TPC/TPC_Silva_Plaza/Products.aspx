<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="TPC_Silva_Plaza.About" %>
    ...
    <div class="col-sm-4 col-md-3">
      ...
      <form class="shop__filter">
        ...
        <%--<%foreach (Dominio.Categoria item in lista)
            {%>
            <div class="checkbox">
                <asp:CheckBox Text="<% = item.Nombre %>" runat="server" />
                <input type="checkbox" value="" id="shop-filter-checkbox_1" checked="">
                <label for="shop-filter-checkbox_1"><% = item.Nombre; %></label>
            </div>
          <%}%>--%>
        <!-- Radios -->
        <h3 class="headline">
